within LargeTESmtk.Components.FluidDomain.Examples.Cylinder.Parameters;
record ModelParameters "Record with common model parameters for example models"

  parameter Modelica.Units.SI.Radius r = 34.5 "Radius";

  extends LargeTESmtk.Components.FluidDomain.Examples.Parameters.PartialModelParameters_FluidDom;
