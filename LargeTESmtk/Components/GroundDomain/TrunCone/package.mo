...
package TrunCone "[under construction] Ground domain models for truncated cone fluid domain geometry"
...
<p>
This package includes different ground domain models for an inverted truncated cone fluid domain geometry. 
