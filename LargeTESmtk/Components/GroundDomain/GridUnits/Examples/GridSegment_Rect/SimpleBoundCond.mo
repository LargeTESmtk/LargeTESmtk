within LargeTESmtk.Components.GroundDomain.GridUnits.Examples.GridSegment_Rect;
model SimpleBoundCond "Example model with simplified boundary conditions"
  ...
  Parameters.ModelParameters modelPar annotation (Placement(transformation(extent={{-100,80},{-80,100}})));
equation
