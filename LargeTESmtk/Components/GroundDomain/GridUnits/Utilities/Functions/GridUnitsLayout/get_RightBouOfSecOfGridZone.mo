...
function get_RightBouOfSecOfGridZone
  ...
  output Modelica.Units.SI.Radius r_SD_r[size(dr_SD,1)] "Left boundaries of sections of sub-domain (global)";

protected
  Modelica.Units.SI.Radius r_SD_l[size(dr_SD,1)] "Left boundaries of sections of sub-domain (global)";
...
end get_RightBouOfSecOfGridZone;
