...
function get_BottomBouOfSecOfGridZone
  ...
  output Modelica.Units.SI.Radius z_SD_b[size(dz_SD,1)] "Bottom boundaries of sections of sub-domain (global)";

protected
  Modelica.Units.SI.Distance z_SD_t[size(dz_SD,1)] "Top boundaries of sections of sub-domain (global)";
...
end get_BottomBouOfSecOfGridZone;
