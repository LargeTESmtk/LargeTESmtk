...
model InsulationExtension "Model demonstrating the application of a cover insulation extension"
  extends LargeTESmtk.TankTES.Cylinder.Examples.FullyBuried_CustomGD.NonUniformGround(modelPar(M_InsExt_r=10));
...
<p>
This is the same example model as <a href=\"modelica://LargeTESmtk.TankTES.Cylinder.Examples.FullyBuried_CustomGD.NonUniformGround\">NonUniformGround</a>, 
