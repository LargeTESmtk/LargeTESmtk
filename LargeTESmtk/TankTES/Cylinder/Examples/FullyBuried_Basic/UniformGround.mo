...
model UniformGround "Basic model with uniform ground properties"
  extends LargeTESmtk.TankTES.Cylinder.Examples.TestFrameworks.TestFramework(redeclare
      LargeTESmtk.TankTES.Cylinder.Examples.FullyBuried_Basic.Parameters.ModelParameters modelPar, redeclare
      LargeTESmtk.TankTES.Cylinder.FullyBuried_Basic storage(
      ...
      thermProp_GD_unif=modelPar.gP_Uniform));
...
<p>
This example model demonstrates a basic model configuration with uniform ground properties.  
</p>
