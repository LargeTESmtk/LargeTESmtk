...
model WithRadiation "Model with enabled radiative heat transfer"
  extends LargeTESmtk.TankTES.Cylinder.Examples.FullyBuried_Basic.UniformGround(                    break sou_T_amb, modelPar(useRadHeatTransfer_GD=true,
        useRadHeatTransfer_Co=true));

  IBPSA.BoundaryConditions.WeatherData.ReaderTMY3     weaDat(filNam=ModelicaServices.ExternalReferences.loadResource("modelica://IBPSA/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos"),
